...
# decks = ['Also sprach Zarathustra', 'Enten-eller', 'Horus Heresy', 'QI', 
#'Автостопом', 'Афоризмы житейской мудрости', 'Болезнь к Смерти',
#'Великий и Могучий', 'Герои и героини (INACTIVE)', 'Главные вопросы', 
#'Греция - Рим (INACTIVE)', 'Евангелие страданий', 'Закат Европы', 
#'Критика чистого разума (INACTIVE)', 'Мир как воля и представление (INACTIVE)', 
#'По ту сторону Добра и Зла', 'Полевая лилия и птица небесная', 'Понятие страха',
#'Философия Канке (Вопросы)', '詩', 'Учитель', ]
